...
void ContentSelectorModel::LoadPluginsContentModel::setEncoding(const QString &encoding)
{
    mEncoding = encoding;
...
int ContentSelectorModel::LoadPluginsContentModel::columnCount(const QModelIndex &parent) const
{
    if (parent.isValid())
        return 0;
...
int ContentSelectorModel::LoadPluginsContentModel::rowCount(const QModelIndex &parent) const
{
    if(parent.isValid())
        return 0;
...
const ContentSelectorModel::EsmFile *ContentSelectorModel::LoadPluginsContentModel::item(int row) const
{
...
ContentSelectorModel::EsmFile *ContentSelectorModel::LoadPluginsContentModel::item(int row)
{
...
const ContentSelectorModel::EsmFile *ContentSelectorModel::LoadPluginsContentModel::item(const QString &name) const
{
...
QModelIndex ContentSelectorModel::LoadPluginsContentModel::indexFromItem(const EsmFile *item) const
{
...
Qt::ItemFlags ContentSelectorModel::LoadPluginsContentModel::flags(const QModelIndex &index) const
{
    if (!index.isValid())
...
QVariant ContentSelectorModel::LoadPluginsContentModel::data(const QModelIndex &index, int role) const
{
    if (!index.isValid())
        return QVariant();
...
bool ContentSelectorModel::LoadPluginsContentModel::setData(const QModelIndex &index, const QVariant &value, int role)
{
    if(!index.isValid())
        return false;
...
bool ContentSelectorModel::LoadPluginsContentModel::insertRows(int position, int rows, const QModelIndex &parent)
{
    if (parent.isValid())
        return false;
...
Qt::DropActions ContentSelectorModel::LoadPluginsContentModel::supportedDropActions() const
{
    return mDropActions;
}

QStringList ContentSelectorModel::LoadPluginsContentModel::mimeTypes() const
{
    return mMimeTypes;
}

QMimeData *ContentSelectorModel::LoadPluginsContentModel::mimeData(const QModelIndexList &indexes) const
{
...
void ContentSelectorModel::LoadPluginsContentModel::addFile(EsmFile *file)
{
...
void ContentSelectorModel::LoadPluginsContentModel::addFiles(const QString &path)
{
    QDir dir(path);
    QStringList filters;
...
void ContentSelectorModel::LoadPluginsContentModel::sortFiles()
{
...
bool ContentSelectorModel::LoadPluginsContentModel::isChecked(const QString& filepath) const
{
...
bool ContentSelectorModel::LoadPluginsContentModel::isEnabled (QModelIndex index) const
{
...
void ContentSelectorModel::LoadPluginsContentModel::setContentList(const QStringList &fileList, bool isChecked)
{
...
void ContentSelectorModel::LoadPluginsContentModel::refreshModel()
{
    emit dataChanged (index(0,0), index(rowCount()-1,0));
}

bool ContentSelectorModel::LoadPluginsContentModel::setCheckState(const QString &filepath, bool checkState)
{
    if (filepath.isEmpty())
        return false;
...
ContentSelectorModel::ContentFileList ContentSelectorModel::LoadPluginsContentModel::checkedItems() const
{
